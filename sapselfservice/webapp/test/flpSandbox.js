		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SAP Self service",
									"targetURL": "#sapselfservice-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapselfservice-display": {
								"semanticObject": "sapselfservice",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sapselfservice",
									"url": sap.ui.require.toUrl("sapselfservice")
								}
							}
						}
					}
